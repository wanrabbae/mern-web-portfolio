  ...
  const skill = data.map((skl, i) => {
    return (
      <tr key={skl._id}>
        ...
        <td>
          <button
            onClick={() => deleteSkillHandler(skl._id)}
        ...
        <div className="col-md-12">
          <div className="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
            ...
            <button className="btn btn-primary" type="button">
              <NavLink to="/skills" className="text-white text-decoration-none">
                Preview Content
              </NavLink>
            </button>
          </div>
            ...
            <div className="modal-body">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  id="frontend"
                  onChange={(e) =>
                    setSkills({ ...skills, frontend: e.target.value })
                  }
                />
              </div>
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  id="backend"
                  onChange={(e) =>
                    setSkills({ ...skills, backend: e.target.value })
                  }
                />
              </div>
              <div className="form-group mb-3">
          ...
          <div className="modal-content" style={{ backgroundColor: "#1d1f28" }}>
            ...
            <div className="modal-body">
              <input
                ...
                name="id"
                className={`form-control text-white bg-transparent`}
                onChange={(e) => setSkills({ ...skills, id: e.target.value })}
              />
