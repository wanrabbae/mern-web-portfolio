            ...
            <div className="row mt-5" data-aos="fade-right" data-aos-duration="1000">
                <div className="col-md-12">
                    <div className="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
                        <button className="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#createAbout">Add About</button>
                        <button className="btn btn-primary" type="button">
                            <NavLink to="/about" className="text-white text-decoration-none">Preview Content</NavLink>
                        </button>
                    </div>
                    ...
                    <div className="modal-content" style={{ backgroundColor: "#1d1f28" }}>
                        ...
                        <div className="modal-body">
                            <div className="form-group mb-3">
                                ...
                                <textarea value={abouts.content} className={`form-control text-white bg-transparent`} name="content" id="content" cols="30" rows="5" onChange={e => setAbouts({ ...abouts, content: e.target.value })}></textarea>
                            </div>
                            <div className="form-group mb-3">
                                <label htmlFor="profile">Upload Profile</label>
                                <input name="profile" required type="file" className={`form-control text-white bg-transparent`} id="profile" onChange={e => setAbouts({ ...abouts, profile: e.target.files[0] })} />
                            </div>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-danger" data-bs-dismiss="modal">Close</button>
                            {
                                isPending ?
                                    ...
                                    :
                                    <button type="button" className="btn btn-primary" onClick={createAboutHandler}>Save</button>
                            }
                        </div>
                    </div>
                </div>
