...
function ProjectsAdmin() {
  ...
  const updateProjectHandler = async () => {
    ...
    await dispatch(updateProject(formData.get("id"), formData));
  ...
  const project = data.map((prj, i) => {
    return (
      <tr key={prj._id} className="align-middle">
        ...
        <td>
          <button
            onClick={() => deleteProjectHandler(prj._id)}
            className="btn btn-danger me-2"
          >
            Delete
          </button>
          <button
            onClick={() => setProjects({ ...prj, id: prj._id })}
            ...
            <div className="modal-body">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  id="technologies"
                  onChange={(e) =>
                    setProjects({ ...projects, technologies: e.target.value })
                  }
                />
              </div>
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  id="link"
                  onChange={(e) =>
                    setProjects({ ...projects, link: e.target.value })
                  }
                />
              </div>
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  id="github"
                  onChange={(e) =>
                    setProjects({ ...projects, github: e.target.value })
                  }
                />
              </div>
              <div className="form-group mb-3">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  id="image"
                  onChange={(e) =>
                    setProjects({ ...projects, image: e.target.files[0] })
                  }
                />
              </div>
            </div>
          ...
          <div className="modal-content" style={{ backgroundColor: "#1d1f28" }}>
            ...
            <div className="modal-body">
              <input
                ...
                className={`form-control text-white bg-transparent`}
                onChange={(e) =>
                  setProjects({ ...projects, id: e.target.value })
                }
              />
              ...
              <div className="form-group mb-3">
                <label htmlFor="technologies">New Technologies</label>
                <input
                  value={projects.technologies}
                  name="technologies"
                  required
              ...
              <div className="form-group mb-3">
                <label htmlFor="link">New Link Project (Demo)</label>
                <input
                  value={projects.link}
                  name="link"
                  required
              ...
              <div className="form-group mb-3">
                <label htmlFor="github">New Github Project</label>
                <input
                  value={projects.github}
                  name="github"
                  required
